...
hr.PrevVer=Otkrivena je prethodna verzija aplikacije {#sAppName}. Kliknite 'U redu' za deinstalaciju ili 'Odustani' za izlaz iz instalacije.
#if Ver >= EncodeVer(6,1,1)
...
hr.ErrorMismatchInstalledType =Instalirana verzija postavljena je korištenjem drugačije vrste instalacijskog programa. Instalirajte ispravni paket ili deinstalirajte postojeću verziju prije nastavka.
;===============================================================================
...
hr.ErrorMismatchInstalledArch =Arhitektura instalirane verzije ne odgovara ovom paketu. Instalirajte ispravni paket ili deinstalirajte postojeću verziju prije nastavka.
;===============================================================================
...
hr.ErrorMismatchInstalledEdition =Izdanje instalirane verzije ne odgovara ovom paketu. Instalirajte ispravni paket ili deinstalirajte postojeću verziju prije nastavka.
;===============================================================================
...
hr.UpdateService =Usluga ažuriranja za {#sAppName}
...
hr.extPOT =PowerPoint predložak
...
hr.extPPTM =PowerPoint Open XML prezentacija s omogućenim makronaredbama
...
hr.extFB2 =FictionBook 2.0 datoteka
...
hr.extDOTX =Word Open XML predložak dokumenta
...
km.AdditionalTasks=ភារកិច្ច៖
km.AppLocale=km-KH
km.AssociateAll=ភ្ជាប់ទាំងអស់
km.AssociateAudio=File types
km.AssociateCaption=ការភ្ជាប់ប្រភេទឯកសារ
km.AssociateDescription=ភ្ជាប់ប្រភេទឯកសារការិយាល័យជាមួយ {#ASSC_APP_NAME}
km.AssociateDont=មិនភ្ជាប់អ្វីទាំងអស់
km.AssociateSel=ភ្ជាប់តែឯកសារដែលបានជ្រើស
km.CreateDesktopIcon=បង្កើតរូបតំណាង %1 នៅលើផ្ទៃតុ(&d)
km.ErrorMismatchInstalledArch=The architecture of the installed version does not match this package. Please install the correct package or uninstall the existing version before continuing.
km.ErrorMismatchInstalledEdition=The edition of the installed version does not match this package. Please install the correct package or uninstall the existing version before continuing.
km.ErrorMismatchInstalledType=The installed version was deployed using a different type of installer. Please install the correct package or uninstall the existing version before continuing.
km.InstallAdditionalComponents=កំពុងដំឡើងធាតុផ្សំបន្ថែមរបស់ប្រព័ន្ធ។ សូមរង់ចាំ...
km.Launch=ដំណើរការ %1
km.PrevVer=រកឃើញជំនាន់មុនរបស់ {#sAppName} សូមចុច 'យល់ព្រម' ដើម្បីលុបវាចេញ ឬចុច 'បោះបង់' ដើម្បីចាកចេញពីការដំឡើង។
km.Uninstall=លុបចេញ
km.UninstallOptionClearData=លុបការកំណត់អ្នកប្រើ និងទិន្នន័យបណ្ដោះអាសន្នទាំងអស់
km.UninstallPageLabel=ចុច លុបចេញ ដើម្បីបន្តការលុបចេញ។
km.UpdateAppRunning=កម្មវិធីដំឡើងរកឃើញថា %1 កំពុងដំណើរការ។%n%nវានឹងត្រូវបិទដោយស្វ័យប្រវត្តិ។ ចុច យល់ព្រម ដើម្បីបន្ត ឬ បោះបង់ ដើម្បីចាកចេញ។
km.UpdateService=សេវាកម្មធ្វើបច្ចុប្បន្នភាពសម្រាប់ {#sAppName}
km.WarningClearAppData=តើអ្នកចង់លុបការកំណត់អ្នកប្រើ និងទិន្នន័យបណ្ដោះអាសន្នទាំងអស់មែនទេ?
km.WarningWrongArchitecture=អ្នកកំពុងព្យាយាមដំឡើងកម្មវិធីជំនាន់ %1-bit លើជំនាន់ %2-bit ដែលបានដំឡើងរួច។ សូមលុបជំនាន់មុនចេញជាមុនសិន ឬទាញយកជំនាន់ដែលត្រឹមត្រូវ។
km.defprogAppDescription=កម្មវិធីការិយាល័យលើកុំព្យូទ័រ សម្រាប់កែសម្រួលឯកសារ និងសហការងារ
km.extCSV=Comma Separated Values
km.extDJVU=Digital Document
km.extDOC=Word 97-2003 Document
km.extDOCX=Office Open XML Document
km.extDOCXF=ONLYOFFICE Form Template
km.extDOTX=Word Open XML Document Template
km.extEPUB=Open eBook File
km.extFB2=FictionBook 2.0 File
km.extFODS=OpenDocument Flat XML Spreadsheet
km.extFODT=OpenDocument Flat XML Document
km.extMSExcel=Microsoft Excel Workbook
km.extMSPresentation=Microsoft PowerPoint Presentation
km.extMSSlideshow=Microsoft PowerPoint Slideshow
km.extMSWord=Microsoft Word Document
km.extODP=OpenDocument Presentation
km.extODS=OpenDocument Spreadsheet
km.extODT=OpenDocument Text File
km.extOXPS=Open XML Paper Specification
km.extPDF=Portable Document
km.extPOT=PowerPoint Template
km.extPPS=PowerPoint 97-2003 Slide Show
km.extPPSX=Office Open XML Slide Show
km.extPPT=PowerPoint 97-2003 Presentation
km.extPPTM=PowerPoint Open XML Macro-Enabled Presentation
km.extPPTX=Office Open XML Presentation
km.extRTF=Rich Text Format File
km.extVSDX=Visio Drawing
km.extXLS=Excel 97-2003 Spreadsheet
km.extXLSB=Excel Binary File Format
km.extXLSM=Microsoft Excel Macro-Enabled Workbook
km.extXLSX=Office Open XML Spreadsheet
km.extXPS=Open XML Paper Specification
km.jumpDOCX=New document
km.jumpDOCXF=New PDF
km.jumpPPTX=New presentation
km.jumpXLSX=New spreadsheet
km.runOpenDefaultApps=បើក កម្មវិធីលំនាំដើម
km.warnWin10FileAssociationDesc=ដើម្បីភ្ជាប់ឯកសារជាមួយកម្មវិធី សូមបើកផ្ទាំងខាងក្រោម បន្ទាប់ពីការដំឡើងបញ្ចប់៖
km.warnWin10FileAssociationPath=ការកំណត់ > កម្មវិធី > កម្មវិធីលំនាំដើម
