l10n.en_GB = {
    welWelcome: 'Welcome to Typsastra!',
    welDescr: 'Work on documents offline or connect the suite to your cloud: Typsastra, ownCloud, Nextcloud.',
    welNeedHelp: 'Need help? Visit our $1.',
    textHelpCenter: 'Help Center',
    btnConnect: 'Connect now',
    textHavePortal: 'Already use a cloud?',
    btnCreatePortal: 'Create an Typsastra cloud',
    ...
    portalEmptyAdv1: 'Don\'t have a cloud account yet? Go online with Typsastra Cloud Service and <br />try collaborative capabilities for free.',
    ...
    linkCreatePortal: 'Create an Typsastra cloud',
    ...
    loginNoteAssignPhone: 'The two-factor authentication is enabled to provide additional Typsastra cloud security. Enter your mobile phone number to continue work on the cloud office. Mobile phone number must be entered using an international format with country code.',
    ...
    emptySlide3Text: 'Store your documents in the Typsastra cloud and access them any time, from anywhere.',
