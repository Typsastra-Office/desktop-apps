l10n.ro = {
    welWelcome: 'Bine ați venit la Typsastra Office Editors!',
    welDescr: 'Lucrați la documente offline sau conecta suitați suitã la cloud: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crearea unui cont Typsastra cloud',
    ...
    portalEmptyAdv1: 'Încã nu aveți un cont Cloud? Lucrați online cu servicii cloud Typsastra ți <br />încercați funcțiile de colaborare gratuit.',
    ...
    loginNoteAssignPhone: 'Autentificarea cu doi factori este activatã ca o mãsurã suplimentarã de securitate pentru Typsastra cloud. Intra-i numãrul de telefon dvs vă sã puteţi continua lucrul în oficiul cloud. Numãrul de telefon mobil trebuie introdus în format internaþional cu prefixul de țarã.',
    ...
    actPreviewTemplates: 'Șablon',
    actClouds: 'Servicii de stocare în cloud',
    actHome: 'Acasă',
    ...
    emptySlide3Text: 'Stocați-vă documentele în Typsastra cloud și le accesati de oriunde, oricând.',
    ...
    settOptThemeWhite: 'Modern luminos',
    settOptThemeNight: 'Modern întunecat',
    ...
    tplErrorTLS: "Windows XP nu acceptă versiunile actuale ale protocoalelor TLS 1.1 și TLS 1.2, prin urmare șabloanele din Cloud nu pot fi utilizate de acest sistem de operare.",
    tplFree: "Gratuit",
    tplUseTemplate: 'Folosire acest șablon',
    tplFileSize: "Dimensiune fișier",
    tplFileType: "Tip fișier",
