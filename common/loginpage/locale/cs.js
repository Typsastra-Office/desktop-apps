l10n.cs = {
    welWelcome: 'Vítejte v Typsastra Office Editors!',
    welDescr: 'Práce na dokumentech offline nebo propojení sady do cloudu: Typsastra, ownCloud, Nextcloud.',
    welNeedHelp: 'Potřebujete pomoct? Navštivte naše $1.',
    textHelpCenter: 'Centrum nápovědy',
    btnConnect: 'Připojit',
    textHavePortal: 'Už používáte cloud?',
    btnCreatePortal: 'Vytvořit Typsastra cloud',
    ...
    portalEmptyAdv1: 'Nemáte ještě cloud účet? Navštivte službu Cloud Service Typsastra a vyzkoušejte možnosti spolupráce zdarma.',
    ...
    linkCreatePortal: 'Vytvořit Typsastra cloud',
    ...
    loginNoteAssignPhone: 'K zajištění další bezpečnosti Typsastra cloud je zapnuto dvoufaktorové ověřování. Zadejte své číslo mobilního telefonu, abyste mohli pokračovat v práci na kanceláře cloud. Číslo mobilního telefonu musí být zadáno pomocí mezinárodního formátu s kódem země.',
