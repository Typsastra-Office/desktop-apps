l10n.el = {
    welWelcome: 'Καλώς ήλθατε στο Typsastra Office Editors!',
    welDescr: 'Εργαστείτε εκτός σύνδεσης με έγγραφα ή συνδέστε τη σουίτα στο cloud σας: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Δημιουργήστε ένα Typsastra cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με την υπηρεσία Typsastra Cloud και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    strVersion: 'έκδοση',
    strVersionCommunity: 'Κοινοτική έκδοση',
    strVersionCommercial: 'Enterprise έκδοση',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο Typsastra cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
    ...
    settOptThemeWhite: 'Μοντέρνο ανοιχτόχρωμο',
    settOptThemeNight: 'Μοντέρνο σκουρόχρωμο',
    ...
    settOptThemeAddLocal: 'Προσθήκη τοπικού θέματος',
    settOptThemeContrastDark: 'Αντίθεση σκουρόχρωμο',
    settAUpdateMode: 'Ενημερώσεις',
    settOptAUpdateSilent: 'Αυτόματα',
    settOptAUpdateAsk: 'Ειδοποίηση',
    settOptAUpdateDisabled: 'Χειροκίνητα',
    ...
    settGpuUseMode: "Χρήση επιτάχυνσης γραφικών όταν είναι διαθέσιμη",
    tplPDF: "PDF",
    tplDocument: "Έγγραφα",
    tplSpreadsheet: "Υπολογιστικά φύλλα",
    tplPresentation: "Παρουσιάσεις",
    tplSearch: "Αναζήτηση προτύπων",
    tplSearchResult: "Αποτελέσματα για",
    tplNoResultsTitle: "Δεν βρέθηκε τίποτα",
    tplNoResultsText: "Δεν βρέθηκαν αποτελέσματα που να ταιριάζουν με την αναζήτησή σας",
    tplErrorTLS: "Τα Windows XP δεν υποστηρίζουν τις τρέχουσες εκδόσεις πρωτοκόλλου TLS 1.1 και TLS 1.2, επομένως τα πρότυπα cloud δεν μπορούν να χρησιμοποιηθούν σε αυτό το λειτουργικό σύστημα.",
    tplFree: "Δωρεάν",
    tplUseTemplate: 'Χρησιμοποιήστε αυτό το πρότυπο',
    tplFileSize: "Μέγεθος αρχείου",
    tplFileType: "Τύπος αρχείου",
