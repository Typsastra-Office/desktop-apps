l10n.es = {
    welWelcome: '¡Bienvenido a Typsastra Office Editors!',
    welDescr: 'Trabaje en documentos «offline» o conecte la suite a su nube: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crear cuenta de Typsastra en la nube',
    ...
    portalEmptyAdv1: '¿Todavía no tiene su cuenta en la nube? Conéctese en línea con el Servicio de Typsastra en la nube y pruebe sus prestaciones de colaboración gratis.',
    ...
    emptySlide3Text: 'Almacene sus documentos en la nube de Typsastra y acceda en cualquier momento y desde cualquier lugar.',
    ...
    settOptThemeWhite: 'Moderno claro',
    settOptThemeNight: 'Moderno oscuro',
    ...
    settOptAUpdateDisabled: 'Manualmente',
    ...
    tplErrorTLS: "Windows XP no es compatible con las versiones actuales de los protocolos TLS 1.1 y TLS 1.2, por lo que las plantillas de nube no se pueden utilizar en este sistema operativo.",
    tplFree: "Gratis",
    tplUseTemplate: 'Utilizar esta plantilla',
    tplFileSize: "Tamaño de archivo",
    tplFileType: "Tipo de archivo",
    ...
    settUseAI: 'Utilice funciones de IA',
}
