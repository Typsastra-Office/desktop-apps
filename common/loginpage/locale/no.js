l10n.no = {
    welWelcome: 'Velkommen til Typsastra redigeringsprogrammer for PC!',
    welDescr: 'Arbeid med dokumenter offline eller koble suiten til din skykonto: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Lag en Typsastra-sky',
    ...
    portalEmptyAdv1: 'Har du ikke konto enda? Koble deg til nettet med Typsastra skytjeneste og <br />prøv samarbeidsfunksjonene gratis.',
    ...
    linkCreatePortal: 'Sett opp en Typsastra-sky',
    ...
    loginNoteAssignPhone: 'To-faktor-godkjenning er aktivert for å gi ekstra skysikkerhet for Typsastra. Skriv inn mobilnummeret ditt for å fortsette å arbeide på skykontoret. Mobiltnummer må angis med et internasjonalt format med landskode.',
    ...
    emptySlide3Text: 'Lagre dokumentene dine i Typsastra-skyen og få tilgang til dem når som helst, fra hvor som helst.',
    ...
    settSpellcheckDetection: 'Språkgjenkjenning for stavekontroll',
    settOptDisabled: 'Deaktivert',
    settOptEnabled: 'Enabled',
    aboutChangelog: 'Endringslogg',
    updateNoUpdates: 'Appen er oppdatert',
    updateAvialable: 'Versjon $1 er tilgjengelig. Klikk for å laste ned.',
    settOptThemeSystem: 'Samme som systemet',
    settOptThemeAddLocal: 'Legg til lokalt tema',
    settOptThemeContrastDark: 'Kontrast mørk',
    settAUpdateMode: 'Oppdateringer',
    settOptAUpdateSilent: 'Automatisk',
    settOptAUpdateAsk: 'Gi beskjed',
    settOptAUpdateDisabled: 'Manuelt',
    updateDownloadFinished: 'Nedlastingen er fullført. Klikk for å installere',
    updateDownloadCanceled: 'Nedlastingen ble avbrutt',
    updateDownloadProgress: 'Laster ned $1%. Klikk for å stoppe',
