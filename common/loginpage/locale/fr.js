l10n.fr = {
    welWelcome: 'Bienvenue sur Typsastra Office Editors !',
    welDescr: 'Travaillez avec vos documents en mode hors-connexion ou connectez la suite à votre Cloud : Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Créer un compte Cloud Typsastra',
    ...
    portalEmptyAdv1: 'Vous n\'avez pas encore de compte Cloud ? Accéder en ligne avec Typsastra et essayez les capacités de gestion collaborative gratuitement.',
    ...
    menuFilePin: 'Épingler',
    menuFileUnpin: 'Désépingler',
    textMyComputer: 'Mon poste de travail',
    textThrough: 'par',
    linkForgotPass: 'Mot de passe oublié ?',
    linkCreatePortal: 'Créer un compte Cloud Typsastra',
    ...
    emptySlide3Text: 'Stockez vos documents dans Typsastra Cloud et accedez-y depuis n\'importe où et à n\'importe quel moment.',
    ...
    tplErrorTLS: "Windows XP ne prend pas en charge les versions actuelles des protocoles TLS 1.1 et TLS 1.2. Par conséquent, les modèles Cloud ne peuvent pas être utilisés sur ce système d'exploitation.",
    tplFree: "Gratuit",
    tplUseTemplate: 'Utiliser ce modèle',
    tplFileSize: "Taille du fichier",
    tplFileType: "Type de fichier",
