l10n.he = {
    welWelcome: 'ברוכים הבאים לעורכי שולחן העבודה של Typsastra!',
    welDescr: 'לעבוד על מסמכים במצב לא מקוון או לחבר את החבילה לענן שלך: Typsastra, ownCloud, Nextcloud.',
    welNeedHelp: 'צריך עזרה? בקר באתר שלנו ב-$1',
    textHelpCenter: 'מרכז עזרה',
    btnConnect: 'התחבר עכשיו',
    textHavePortal: 'כבר משתמשים בענן?',
    btnCreatePortal: 'צור ענן Typsastra',
    ...
    portalEmptyAdv1: 'עדיין אין לך חשבון ענן? עבור למצב מקוון עם Typsastra Cloud Service ו- <br />נסה יכולות שיתוף פעולה בחינם.',
    ...
    menuLogout: 'התנתקות',
    menuFilePin: 'הצמדה',
    menuFileUnpin: 'ביטול הצמדה',
    textMyComputer: 'המחשב שלי',
    textThrough: 'דרך',
    linkForgotPass: 'שכחת סיסמא?',
    linkCreatePortal: 'צור ענן Typsastra',
    ...
    loginNoteAssignPhone: 'האימות הדו-שלבי מופעל כדי לספק אבטחת ענן נוספת של Typsastra. הזן את מספר הטלפון הנייד שלך כדי להמשיך לעבוד במשרד הענן. יש להזין את מספר הטלפון הנייד בפורמט בינלאומי עם קידומת מדינה.',
    ...
    emptySlide3Text: 'אחסן את המסמכים שלך בענן Typsastra וגש אליהם בכל עת ומכל מקום.',
    ...
    settOptThemeGray: 'אפור',
    settOptThemeWhite: 'מודרני בהיר',
    settOptThemeNight: 'מודרני כהה',
    ...
    tplPDF: "קבצי PDF",
    tplDocument: "מסמכים",
    tplSpreadsheet: "גיליונות אלקטרוניים",
    tplPresentation: "מצגות",
    tplSearch: "חיפוש תבניות",
    tplSearchResult: "תוצאות עבור",
    tplNoResultsTitle: "לא נמצא דבר",
    tplNoResultsText: "לא מצאו תוצאות התואמות את השאילתה",
    tplErrorTLS: "Windows XP אינו תומך בגרסאות הפרוטוקול הנוכחיות של TLS 1.1 ו-TLS 1.2, לכן לא ניתן להשתמש בתבניות ענן במערכת הפעלה זו.",
    tplFree: "חינם",
    tplUseTemplate: 'השתמש בתבנית זו',
    tplFileSize: "גודל הקובץ",
    tplFileType: "סוג קובץ",
    colFileName: "שם הקובץ",
    colLocation: 'מיקום',
