l10n.pt_BR = {
    welWelcome: 'Bem-vindo ao Typsastra Office Editors!',
    welDescr: 'Trabalhe em documentos offline ou conecte-se à sua nuvem: Typsastra, ownCloud, Nextcloud.',
    welNeedHelp: 'Precisa de ajuda? Visite nossa $1.',
    textHelpCenter: 'Central de Ajuda',
    btnConnect: 'Conectar',
    textHavePortal: 'Já usa o nuvem?',
    btnCreatePortal: 'Criar Typsastra na nuvem',
    ...
    portalEmptyAdv1: 'Ainda não tem uma conta? Experimente colaboracão na nuvem do Typsastra gratuitamente.',
    ...
    menuLogout: 'Logout',
    menuFilePin: 'Fixar',
    menuFileUnpin: 'Desafixar',
    textMyComputer: 'Meu Computador',
    textThrough: 'através',
    linkForgotPass: 'Esqueceu a senha?',
    linkCreatePortal: 'Criar Typsastra na nuvem',
    ...
    loginNoteAssignPhone: 'A autenticação de dois fatores está habilitada para fornecer segurança adicional ao nuvem do Typsastra. Insira o seu número de celular para continuar trabalhando no escritório na nuvem. O número de telefone deve ser inserido usando um formato internacional com o código do país.',
    ...
    actPreviewTemplates: 'Modelo',
    actClouds: 'Nuvens',
    actHome: 'Página Inicial',
    ...
    strVersion: 'versão',
    strVersionCommunity: 'Versão da comunidade',
    strVersionCommercial: 'Versão empresarial',
    ...
    emptySlide3Text: 'Armazene seus documentos na nuvem do Typsastra e acesse-os a qualquer momento, de qualquer lugar.',
    settUserName: 'Nome de usuário',
    settResetUserName: 'Voltar para o padrão',
    settOpenMode: 'Pré-visualização',
    setBtnApply: 'Aplicar',
    settLanguage: 'Idioma de Interface',
    settAfterRestart: 'Ás alterações serão aplicadas após reiniciar o aplicativo',
    ...
    settOptThemeGray: 'Cinza',
    settOptThemeWhite: 'Claro moderno',
    settOptThemeNight: 'Escuro moderno',
    ...
    updateAvialable: 'A versão $1 está disponível. Clique para baixar.',
    ...
    tplErrorTLS: "O Windows XP não suporta as versões atuais dos protocolos TLS 1.1 e TLS 1.2, portanto, os Modelos na Nuvem não podem ser usados ​​neste sistema operacional.",
    tplFree: "Gratuito",
    tplUseTemplate: 'Usar este modelo',
    tplFileSize: "Tamanho do arquivo",
    tplFileType: "Tipo de arquivo",
