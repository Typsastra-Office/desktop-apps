l10n.fi = {
    welWelcome: 'Tervetuloa Typsastra Työpöytä Editoriin!',
    welDescr: 'Työskentele ilman verkkoyhteyttä tai yhdistä pilveesi: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Luo Typsastra pilvi',
    ...
    portalEmptyAdv1: 'Eikö sinulla ole vielä pilveä? Ota yhteys verkkoon TypsastraN pilvipalvelulla ja <br />kokeile yhteistyö-mahdollisuuksia ilmaiseksi.',
    ...
    linkCreatePortal: 'Luo Typsastra pilvi',
    ...
    loginNoteAssignPhone: 'Kaksi-vaiheinen tunnistus on otettu käyttöön, tuomaan lisäturvaa TypsastraN pilveen. Syötä puhelinnumerosi, jatkaaksesi työskentelyä pilvi-officessa. Puhelinnumero tulee syöttää käyttäen kansainvälistä muotoa maatunnuksella.',
    ...
    emptySlide3Text: 'Säilö dokumenttisi TypsastraN pilveen ja käytä niitä million tahansa, missä tahansa.',
    ...
    settOptThemeAddLocal: 'Lisää paikallinen teema',
    settOptThemeContrastDark: 'Tumma kontrasti',
    settAUpdateMode: 'Päivitykset',
    settOptAUpdateSilent: 'Automaattinen',
    settOptAUpdateAsk: 'Ilmoita',
    settOptAUpdateDisabled: 'Manuaalinen',
    ...
    settGpuUseMode: "Käytä grafiikkakiihdytystä, kun se on mahdollista",
    tplPDF: "PDF:t",
    tplDocument: "Asiakirjat",
    tplSpreadsheet: "Laskentataulukot",
    tplPresentation: "Esitykset",
    tplSearch: "Hae malleja",
    tplSearchResult: "Tulokset haulle",
    tplNoResultsTitle: "Mitään ei löytynyt",
    tplNoResultsText: "Hakuasi vastaavia tuloksia ei löytynyt",
    colFileName: "Tiedostonimi",
