l10n.sr_Latn_RS = {
    welWelcome: 'Dobro došli u Typsastra Office Uređivače!',
    welDescr: 'Radite na dokumentima oflajn ili konektujte paket na svoj oblak: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Kreiraj Typsastra oblak',
    ...
    portalEmptyAdv1: 'Još uvek nemate oblak račun? Idite onlajn sa Typsastra Oblak Servisom i <br />pokušajte sarađivačke sposobnosti besplatno.',
    ...
    loginNoteAssignPhone: 'Dvofaktorska autentikacija je omogućena da obezbedi dodatnu Typsastra oblak bezbednost. Unesite svoj broj telefona da nastavite rad na oblak ofis-u. Broj mobilnog telefona mora biti unet koristeći internacionalni format sa kodom države.',
    ...
    emptySlide3Text: 'Skladišti svoje dokumente u Typsastra oblaku i pristupi im bilo kada, sa bilo kog mesta.',
    ...
    tplErrorTLS: "Windows XP ne podržava trenutnu TLS 1.1 i TLS 1.2 verziju protokola, pa Cloud Templates ne može biti korišćen na ovom operativnom sistemu.",
    tplFree: "Besplatno",
    tplUseTemplate: 'Koristite ovaj šablon',
    tplFileSize: "Veličina fajla",
    tplFileType: "Tip fajla",
