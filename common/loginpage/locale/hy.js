l10n.hy = {
    welWelcome: 'Բարի գալուստ Typsastra աշխատանքային սեղանի խմբագրիչներ',
    welDescr: 'Աշխատեք փաստաթղթերի վրա օֆֆլայն կամ միացրեք Ձեր փաթեթը Ձեր ամպին՝ Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Ստեղծել Typsastra ամպ',
    ...
    portalEmptyAdv1: 'Դեռևս չունե՞ք ամպային հաշիվ։ Դարձեք առցանց Typsastra ամպային ծառայության հետ և <br />անվճար փորձեք համագործակցային հնարավորությունները։',
    ...
    menuFilePin: 'Ամրացնել',
    menuFileUnpin: 'Հանել ամրացումից',
    textMyComputer: 'Իմ համակարգիչը',
    textThrough: 'միջով',
    linkForgotPass: 'Մոռացե՞լ եք գաղտնաբառը',
    linkCreatePortal: 'Ստեղծել Typsastra ամպ',
    ...
    loginNoteAssignPhone: 'Երկու գործոնով վավերացումն միացված է, որպեսզի ապահովվի Typsastra ամպի լրացուցիչ անվտանգություն։ Մուտքագրեք Ձեր հեռախոսահամարը, որպեսզի շարունակեք աշխատել ամպային office-ում։ Հեռախոսահամարը պետք է մուտքագրվի երկրի կոդով՝ ըստ միջազգային ֆորմատի։',
    ...
    strVersion: 'տարբերակ',
    strVersionCommunity: 'Community տարբերակ',
    strVersionCommercial: 'Enterprise տարբերակ',
    ...
    emptySlide3Text: 'Պահպանեք Ձեր փաստաթղթերը Typsastra ամպում, և դրանք հասանելի կլինի ցանկացած պահի ցանկացած վայրից։',
    ...
    settOptThemeGray: 'Մոխրագույն',
    settOptThemeWhite: 'Ժամանակակից բաց ռեժիմ',
    settOptThemeNight: 'Ժամանակակից մուգ ռեժիմ',
    ...
    tplSearch: "Որոնել ձևանմուշներ",
    tplSearchResult: "Արդյունքներ՝",
    tplNoResultsTitle: "Ոչինչ չի գտնվել",
    tplNoResultsText: "No results matching your query could be found",
    tplErrorTLS: "Windows XP-ը չի աջակցում TLS 1.1 և TLS 1.2 ժամանակակից պրոտոկոլների տարբերակները, ուստի Cloud Templates-ը հնարավոր չէ օգտագործել այս օպերացիոն համակարգում",
    tplFree: "Անվճար",
    tplUseTemplate: 'Օգտագործել այս ձևանմուշը',
    tplFileSize: "Ֆայլի չափը",
    tplFileType: "Ֆայլի տեսակը",
