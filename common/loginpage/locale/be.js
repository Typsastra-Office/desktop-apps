l10n.be = {
    welWelcome: 'Вітаем у Typsastra Office Editors!',
    welDescr: 'Працуйце з дакументамі ў аўтаномным рэжыме або падлучыцеся да воблака: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Стварыць воблака Typsastra',
    ...
    portalEmptyAdv1: 'У вас яшчэ няма воблачнага акаўнта? Перайдзіце на сеціўны рэжым працы з дапамогай Typsastra Cloud Service і <br/> бясплатна азнаёмцеся з магчымасцямі сумеснай працы.',
    ...
    linkCreatePortal: 'Стварыць воблака Typsastra',
    ...
    pshCode: 'код з SMS',
    loginNoteAssignPhone: 'Каб забяспечыць дадатковую бяспеку Typsastra, уключаная двухфактарная аўтэнтыфікацыя. Каб працягнуць працу ў воблачным офісе, увядзіце нумар мабільнага тэлефона. Нумар мабільнага тэлефона павінен быць уведзены ў міжнародным фармаце з кодам краіны.',
    ...
    emptySlide3Text: 'Захоўвайце свае дакументы ў воблаку Typsastra і працуйце з імі ў любы час з любога месца.',
