l10n.ru = {
    welWelcome: 'Добро пожаловать в Typsastra!',
    welDescr: 'Работайте с документами офлайн или подключитесь к облаку: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Создать облако Typsastra',
    btnAddPortal: 'Добавить облако',
    btnLogin: 'Войти',
    btnBrowse: 'Просмотреть',
    btnNext: 'Далее',
    ...
    portalEmptyAdv1: 'Еще нет облачного аккаунта? Перейдите в онлайн-режим с облачным сервисом Typsastra и попробуйте возможности совместного редактирования бесплатно.',
    ...
    menuClear: 'Очистить',
    menuLogout: 'Выйти',
    menuFilePin: 'Закрепить',
    menuFileUnpin: 'Открепить',
    textMyComputer: 'Мой компьютер',
    textThrough: 'через',
    linkForgotPass: 'Забыли пароль?',
    linkCreatePortal: 'Создать облако Typsastra',
    ...
    loginNoteAssignPhone: 'Для обеспечения повышенной безопасности в облаке Typsastra включена двухфакторная аутентификация. Для продолжения работы в облачном офисе введите ваш номер мобильного телефона. Номер мобильного телефона необходимо ввести в международном формате с кодом страны.',
    ...
    emptySlide3Text: 'Храните документы в облаке Typsastra и получайте к ним доступ в любое время, из любой точки мира.',
    ...
    settOptThemeWhite: 'Современная светлая',
    settOptThemeNight: 'Современная темная',
    ...
    tplFree: "Бесплатно",
    tplUseTemplate: 'Использовать этот шаблон',
    tplFileSize: "Размер файла",
    tplFileType: "Тип файла",
    colFileName: "Имя файла",
    colLocation: "Расположение",
    colLastOpened: "Последнее открытие",
    labelDropFile: 'Перетащите файлы сюда или',
    labelSelectFile: 'Выберите файл',
    settUseAI: 'Используйте функции искусственного интеллекта',
}
