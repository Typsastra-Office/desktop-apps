l10n.ca = {
    welWelcome: 'Benvingut/da a Typsastra Office Editors!',
    welDescr: 'Treballa sense connexió als teus documents o connecta la suite al teu núvol: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crea un núvol Typsastra',
    ...
    portalEmptyAdv1: 'Encara no tens un compte de núvol? Entra en línia amb Typsastra Cloud Service i<br />prova les capacitats col·laboratives de franc.',
    ...
    linkCreatePortal: 'Crea un núvol Typsastra',
    ...
    loginNoteAssignPhone: 'L\'autenticació de dos factors està habilitada per proporcionar seguretat addicional al núvol de Typsastra. Introduïu el número de telèfon mòbil per continuar treballant a l\'oficina del núvol. Cal introduir el número de telèfon mòbil mitjançant un format internacional amb codi de país.',
    ...
    emptySlide3Text: 'Emmagatzema els teus documents al núvol Typsastra i accedeix-hi en qualsevol moment, des de qualsevol lloc.',
    ...
    settSpellcheckDetection: 'Detecció ortogràfica de la llengua',
    settOptDisabled: 'Desactivat',
    settOptEnabled: 'Activat',
    aboutChangelog: 'Registre de canvis',
    ...
    updateDownloadFinished: 'La descàrrega ha finalitzat. Feu clic per instal·lar',
    updateDownloadCanceled: 'Descàrrega cancel·lada',
    updateDownloadProgress: 'Descarregant $1%. Fes clic per pausar',
