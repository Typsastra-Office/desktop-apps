l10n.id = {
    welWelcome: 'Selamat Datang di Typsastra Office Editors!',
    welDescr: 'Mengerjakan dokumen secara luring atau menghubungkannya ke cloud Anda: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Buat cloud Typsastra',
    ...
    portalEmptyAdv1: 'Tidak punya akun cloud? Kesempatan terhubung bersama Layanan Cloud Typsastra dan <br /> mencoba kemampuan kolaboratif secara gratis.',
    ...
    linkCreatePortal: 'Buat cloud Typsastra',
    ...
    loginNoteAssignPhone: 'Autentikasi dua faktor diaktifkan untuk memberikan tambahan keamanan cloud Typsastra. Masukkan nomor ponsel Anda untuk melanjutkan pekerjaan di cloud office. Nomor ponsel harus dimasukkan menggunakan format internasional beserta kode negara.',
    ...
    emptySlide3Text: 'Simpan dokumen Anda di cloud Typsastra dan mengaksesnya kapan saja, dari mana saja.',
    ...
    settSpellcheckDetection: 'Deteksi bahasa ejaan',
    settOptDisabled: 'Nonaktifkan',
    settOptEnabled: 'Aktifkan',
    aboutChangelog: 'Log perubahan',
    ...
    settOptAUpdateAsk: 'Beritahukan',
    settOptAUpdateDisabled: 'Manual',
    updateDownloadFinished: 'Download selesai. Klik untuk instalasi',
    updateDownloadCanceled: 'Download batal',
    updateDownloadProgress: 'Mendownload $1%. Klik untuk berhenti',
