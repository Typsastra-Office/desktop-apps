l10n.sr_Cyrl_RS = {
    welWelcome: 'Добро дошли у Typsastra Десктоп Уређиваче!',
    welDescr: 'Радите на документима офлајн или конектујте пакет на свој облак: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Креирај Typsastra облак',
    ...
    portalEmptyAdv1: 'Још увек немате облак рачун? Идите онлајн са Typsastra Облак сервисом и <br /> покушајте сарађивачке способности бесплатно.',
    ...
    loginNoteAssignPhone: 'Двофакторска аутентикација је омогућена да обезбеди додатну Typsastra облак безбедност. Унесите свој број телефона да наставите рад на облак офис-у. Број мобилног телефона мора бити унет користећи интернационални формат са кодом државе.',
    ...
    emptySlide3Text: 'Складишти своје документе у Typsastra облаку и приступи им било када, са било ког места.',
    ...
    tplErrorTLS: "Windows XP не подржава тренутне TLS 1.1 и TLS 1.2 верзије протокола , па Cloud Templates не може користити на овом оперативном систему.",
    tplFree: "Бесплатно",
    tplUseTemplate: "Користи овај шаблон",
    tplFileSize: "Величина датотеке",
    tplFileType: "Тип датотеке",
