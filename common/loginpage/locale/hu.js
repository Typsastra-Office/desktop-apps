l10n.hu = {
    welWelcome: 'Üdvözöljük az Typsastra Office Editor-ban!',
    welDescr: 'Dolgozzon offline módon a dokumentumain, vagy rendelje hozzá a programcsomagját a felhőhöz: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Typsastra felhő létrehozása',
    ...
    portalEmptyAdv1: 'Még nincs felhő-alapú felhasználói fiókja? Használja az Typsastra Cloud Service-t és <br />próbálja ki az ingyenes kollaborációs lehetőségeket.',
    ...
    linkCreatePortal: 'Hozzon létre egy Typsastra felhőt',
    ...
    loginNoteAssignPhone: 'A kétfaktoros hitelesítés engedélyezve lett, hogy az Typsastra felhő még biztonságosabb lehessen. Adja meg a mobiltelefonszámát, hogy folytatni tudja a munkát a felhőben. A mobiltelefonszámot a nemzetközileg használt formátumban, az országkóddal együtt kell megadni.',
    ...
    emptySlide3Text: 'Tárolja a dokumentumait az Typsastra félhőben, hogy bárhonnan, bármikor hozzájuk férhessen.',
    ...
    settOptThemeWhite: 'Modern Világos',
    settOptThemeNight: 'Modern Sötét',
    settOptLaunchMode: 'Fájl megnyitása',
    settOptLaunchInTab: 'Lapon',
    settOptLaunchInWindow: 'Ablakban',
    settSpellcheckDetection: 'Beviteli nyelv felismerése',
    settOptDisabled: 'Letiltva',
    settOptEnabled: 'Engedélyezve',
    aboutChangelog: 'Változásnapló',
    ...
    settOptAUpdateAsk: 'Értesítés',
    settOptAUpdateDisabled: 'Kézi',
    updateDownloadFinished: 'A letöltés befejeződött. Kattintson a telepítéshez',
    updateDownloadCanceled: 'Letöltés törölve',
    updateDownloadProgress: '$1% letöltése. Kattintson a leállításhoz',
    ...
    tplPDF: "PDF-ek",
    tplDocument: "Dokumentumok",
    tplSpreadsheet: "Táblázatok",
    tplPresentation: "Prezentációk",
    tplSearch: "Sablonok keresése",
    tplSearchResult: "Találatok erre:",
    tplNoResultsTitle: "Semmi sem található",
    tplNoResultsText: "Nem található a lekérdezésének megfelelő eredmény",
    colFileName: "Fájl neve",
