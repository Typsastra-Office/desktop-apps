l10n.hr = {
    welWelcome: 'Dobrodošli u Typsastra uređivače radne površine!',
    welDescr: 'Radite na dokumentima izvanmrežno ili povežite paket na svoj oblak: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Stvorite Typsastra oblak',
    ...
    portalEmptyAdv1: 'Još nemate svoj račun za oblak? Budite na mreži uz uslugu Typsastra oblaka i <br />isprobajte suradničke mogućnosti besplatno.',
    ...
    menuClear: 'Očisti',
    menuLogout: 'Odjava',
    menuFilePin: 'Prikvači',
    menuFileUnpin: 'Otkvači',
    textMyComputer: 'Moje računalo',
    textThrough: 'kroz',
    linkForgotPass: 'Zaboravljena lozinka?',
    linkCreatePortal: 'Stvorite Typsastra oblak',
    ...
    loginNoteAssignPhone: 'Dvostruka provjera autentičnosti omogućena je kako bi pružila dodatnu sigurnost u oblaku Typsastra. Unesite svoj broj mobilnog telefona da biste nastavili raditi u uredskom oblaku. Broj mobilnog telefona treba upisati u međunarodnom formatu s oznakom države.',
    ...
    actTemplates: 'Predlošci',
    actPreviewTemplates: 'Predložak',
    actClouds: 'Oblaci',
    actHome: 'Početna',
    ...
    emptySlide3Text: 'Pohranite svoje dokumente na Typsastra oblak i pristupite im bilo kada i bilo gdje.',
    ...
    settOptThemeWhite: 'Moderna svijetla',
    settOptThemeNight: 'Moderna tamna',
    settOptLaunchMode: 'Otvori datoteku',
    settOptLaunchInTab: 'U kartici',
    settOptLaunchInWindow: 'U prozoru',
    settSpellcheckDetection: 'Prepoznavanje pravopisa jezika',
    settOptDisabled: 'Onemogućeno',
    settOptEnabled: 'Omogućeno',
    aboutChangelog: 'Zapis promjena',
    ...
    settOptAUpdateAsk: 'Obavijesti',
    settOptAUpdateDisabled: 'Ručno',
    updateDownloadFinished: 'Preuzimanje je dovršeno. Kliknite za instalaciju',
    updateDownloadCanceled: 'Preuzimanje je otkazano',
    updateDownloadProgress: 'Preuzimanje $1%. Kliknite za zaustavljanje',
    ...
    tplSpreadsheet: "Proračunske tablice",
    tplPresentation: "Prezentacije",
    tplSearch: "Traži predloške",
    tplSearchResult: "Rezultati za",
    tplNoResultsTitle: "Ništa nije pronađeno",
    tplNoResultsText: "Nisu pronađeni rezultati koji odgovaraju vašem upitu",
    tplErrorTLS: "Windows XP ne podržava trenutne verzije protokola TLS 1.1 i TLS 1.2, stoga se Cloud predlošci ne mogu koristiti na ovom operativnom sustavu.",
    tplFree: "Besplatno",
    tplUseTemplate: 'Koristi ovaj predložak',
    tplFileSize: "Veličina datoteke",
    tplFileType: "Vrsta datoteke",
    colFileName: "Naziv datoteke",
    colLocation: 'Lokacija',
    colLastOpened: 'Zadnji put otvoreno',
    labelDropFile: 'Povucite datoteke ovdje ili',
    labelSelectFile: 'Odaberi datoteku',
