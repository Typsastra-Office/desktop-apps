l10n.it_IT = {
    welWelcome: 'Benvenuti su Typsastra Office Editors!',
    welDescr: 'Lavora ai documenti offline o collega la suite al tuo cloud: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crea Typsastra cloud',
    ...
    portalEmptyAdv1: 'Non hai ancora un account cloud? Vai online con Typsastra Cloud Service e prova le capacità di collaborazione gratis.',
    ...
    loginNoteAssignPhone: 'L\'autenticazione a due fattori è abilitata per fornire ulteriore sicurezza del Typsastra cloud. Inserisci il tuo numero di cellulare per continuare a lavorare sul ufficio cloud. Il numero di cellulare deve essere inserito utilizzando un formato internazionale con prefisso internazionale.',
    ...
    emptySlide3Text: 'Archivia i tuoi documenti nel cloud Typsastra e accedili in qualsiasi momento da qualsiasi luogo.',
    ...
    tplErrorTLS: "Windows XP non supporta le versioni attuali dei protocolli TLS 1.1 e TLS 1.2, pertanto i Modelli Cloud non possono essere utilizzati su questo sistema operativo.",
    tplFree: "Gratuito",
    tplUseTemplate: 'Usa questo modello',
    tplFileSize: "Dimensione file",
    tplFileType: "Tipo di file",
    ...
    settUseAI: 'Utilizza le funzioni AI',
}
