l10n.sq = {
    welWelcome: 'Mirësevini në Typsastra Office Editors!',
    welDescr: 'Punoni me dokumente jashtë linje ose lidhni paketën me renë tuaj kompjuterike: Typsastra, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Krijoni një re Typsastra',
    ...
    portalEmptyAdv1: 'Nuk keni ende një llogari reje? Shkoni në linjë me servisin e resë së Typsastra dhe <br />provoni aftësitë e bashkëpunimit falas.',
    ...
    loginNoteAssignPhone: 'Autentifikimi me dy faktorë aktivizohet për të foruar siguri shtesë në renë kompjuterike Typsastra. Futni numrin tuaj të telefonit për të vazhduar punën në zyrën e resë. NUmri i telefonit duhet të futet duke përdorur një format ndërkombëtar me kodin e shtetit.',
    ...
    emptySlide3Text: 'Ruani dokumentet tuaja në re Typsastra dhe askesojini në çdo kohë, nga kudo.',
    ...
    settOptThemeWhite: 'Drita Moderne',
    settOptThemeNight: 'Errësira Moderne',
    ...
    tplSpreadsheet: "Fletëllogaritëse",
    tplPresentation: "Prezantime",
    tplSearch: "Kërkoni për shabllone",
    tplSearchResult: "Rezultate për",
    tplNoResultsTitle: "Asgjë nuk u gjet",
    tplNoResultsText: "Nuk u gjet asnjë rezultat që përputhet me pyetjen tuaj",
    tplErrorTLS: "Windows XP nuk mbështet versionet aktuale të protokollit TLS 1.1 dhe TLS 1.2, kështu që Shabllonet Cloud nuk mund të përdoren në këtë sistem operativ.",
    tplFree: "Falas",
    tplUseTemplate: 'Përdorni këtë shabllon',
    tplFileSize: "Madhësia e skedarit",
    tplFileType: "Lloji i skedarit",
    colFileName: "Emri i skedarit",
