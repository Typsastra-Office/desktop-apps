l10n.de = {
    welWelcome: 'Willkommen in Typsastra Office-Editoren!',
    welDescr: 'Arbeiten Sie offline an Dokumenten oder verbinden Sie die Suite mit Ihrer Cloud: Typsastra, ownCloud, Nextcloud.',
    welNeedHelp: 'Brauchen Sie Hilfe? Besuchen Sie unser $1.',
    textHelpCenter: 'Hilfe-Center',
    btnConnect: 'Zusammenarbeit',
    textHavePortal: 'Haben Sie Cloud schon benutzt?',
    btnCreatePortal: 'Typsastra-Cloud erstellen',
    ...
    portalEmptyAdv1: 'Haben Sie noch kein Cloud-Konto? Wechseln Sie zum Onlinemodus mit dem Typsastra Cloud Service und testen Sie die Möglichkeiten zur Zusammenarbeit  kostenlos.',
    ...
    menuLogout: 'Abmelden',
    menuFilePin: 'Pinnen',
    menuFileUnpin: 'Entpinnen',
    textMyComputer: 'Arbeitsplatz',
    textThrough: 'durch',
    linkForgotPass: 'Passwort vergessen?',
    linkCreatePortal: 'Typsastra-Cloud erstellen',
    ...
    loginNoteAssignPhone: 'Die Zwei-Faktor-Authentifizierung ermöglicht zusätzliche Typsastra Cloud Sicherheit. Geben Sie Ihre Handynummer ein, um die Arbeit am Cloud-Büro fortzusetzen. Die Handynummer muss in einem internationalen Format mit Ländervorwahl eingegeben werden.',
    ...
    emptySlide3Text: 'Speichern Sie Ihre Dokumente in der Typsastra-Cloud und greifen Sie darauf jederzeit von überall zu.',
    ...
    settOptThemeWhite: 'Modern Hell',
    settOptThemeNight: 'Modern Dunkel',
    ...
    tplErrorTLS: "Windows XP unterstützt die aktuellen Protokollversionen TLS 1.1 und TLS 1.2 nicht, daher können Cloud-Vorlagen auf diesem Betriebssystem nicht verwendet werden.",
    tplFree: "Kostenlos",
    tplUseTemplate: 'Diese Vorlage verwenden',
    tplFileSize: "Dateigröße",
    tplFileType: "Dateityp",
