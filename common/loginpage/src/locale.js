...
var l10n = l10n || {};
l10n.en = {
    welWelcome: 'Welcome to Typsastra Office!',
    ...
    btnCreatePortal: 'Create a cloud office',
    ...
    linkCreatePortal: 'Create a cloud office',
    ...
    loginNoteAssignPhone: 'The two-factor authentication is enabled to provide additional cloud security. Enter your mobile phone number to continue work on the cloud office. Mobile phone number must be entered using an international format with country code.',
    ...
    emptySlide3Text: 'Store your documents in your cloud and access them any time, from anywhere.',
